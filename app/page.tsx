        ...
        <tbody>
          {rankings.map((item: Ranking, index: number) => {
            ...
            return (
              ...
              >
                <td className="group">
                  <div className="flex gap-4 items-center group-hover:bg-[--hover-bg-color] group-hover:text-black py-4 px-6 h-16">
                    <div>{index + 1}</div>
                    <Link href={`/rate/${item.name}`} className="text-4xl hover:underline font-bold">
